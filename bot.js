...
const youtube = new YouTube('AIzaSyBQHHnKnL_jfOdNwZahjopFMJs2ZbaHBPk')
...
**»** ${playlist.title}`)
    ...
    if(!searchString) {
        msg.channel.send({embed: new Discord.RichEmbed()
                        ...
                        .setDescription(`**Kullanım:**  -çal <search>
...
client.login("NTAwOTUxNzYzMDQyNDM1MDk1.XPBH1g.N50S1B6Fx2kiWPXYx_HgHKkvRzM")
